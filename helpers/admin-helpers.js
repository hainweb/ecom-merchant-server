            ...
            $facet: {
              ...
              lastActiveCounts: [
                ...
                },
                {
                  $group: {
                    _id: {
                      dayOfWeek: "$dayOfWeek",
                      date: { $dateToString: { format: "%Y-%m-%d", date: "$lastActiveDate" } }
                    },
                    active: { $sum: 1 }
                  }
                }
              ...
              returningUsers: [
                ...
                },
                {
                  $addFields: {
                    inactivePeriod: {
                      $subtract: ["$lastActiveDate", { $toDate: "$LastActive" }]
                    }
                  }
                },
                {
                          ...
                          matchingDate: {
                            $first: {
                              $filter: {
                                ...
                                as: "la",
                                cond: { $eq: ["$$la._id.dayOfWeek", "$$day.dayNum"] }
                              }
                            }
                          }
                        },
                        ...
                        vars: {
                          matchingActive: {
                            $filter: {
                              input: "$lastActiveCounts",
                              as: "act",
                              cond: { $eq: ["$$act._id.dayOfWeek", "$$day.dayNum"] }
                            }
                          }
                        },
                        in: {
                        ...
                        vars: {
                          matchingNew: {
                            $filter: {
                              ...
                              as: "new",
                              cond: { $eq: ["$$new._id.dayOfWeek", "$$day.dayNum"] }
                            }
                          }
                        },
                        in: {
                        ...
                        vars: {
                          matchingReturning: {
                            $filter: {
                              ...
                              as: "ret",
                              cond: { $eq: ["$$ret._id.dayOfWeek", "$$day.dayNum"] }
                            }
                          }
                        },
                        in: {
                          $ifNull: [{ $first: "$$matchingReturning.returning" }, 0]
                        }
                      }
                    }
                  }
